...
COMMIT_MESSAGES = [
    ...
    "Devs aren't things",
    "Another status meeting? why?",
    "Estimate what you can't predict?",
    "Standups, again? why tho",
    "Ceremony for everything? why",
    "Velocity = worth? since when",
    "Burndown chart = trust? lol",
    "More commits = more value? lol",
    "Control instead of trust?",
    "Managers understand the code? never",
    "Story point, whos business is it?",
    "Still measuring people like machines?",
    "Retro, again? nothing changes anyway",
    "Sprint goal? nobody remembers",
    "Scrum Master certified in inefficiency lol",
    "Agile coach? slowness coach",
    "Trust the devs; wild idea huh?",
    "Less meetings more productivity; revolutionary wow",
    "Who's the customer, the manager or the end user?",
